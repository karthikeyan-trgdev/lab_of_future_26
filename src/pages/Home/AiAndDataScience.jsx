  ...
  <section className="cert-section cert-section--robotics cert-section--ai">
    ...
    <div className="cert-robotics-inner container">
      ...
      <div className="cert-robotics-text">
        ...
        <p>Students receive an Artificial Intelligence certification that recognises their hands-on skills, practical knowledge, and successful completion of each AI learning level.</p>
      </div>
...
const AiAndDataScience = () => {
  ...
  useEffect(() => {
    document.body.classList.add("ai-data-science-page");
    return () => document.body.classList.remove("ai-data-science-page");
  }, []);
