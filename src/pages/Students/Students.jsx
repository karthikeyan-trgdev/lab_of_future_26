...
import lofMainLogo       from '../../assets/lof-logo.png';
...
const PROGRAM_IMAGES = [
  programImg1, programImg2, programImg3,
  programImg4, programImg5, programImg6,
  programImg7, programImg8, programImg9,
];

/* "Programs" section — card grid.  Each entry maps to a live
   program detail page via `slug` → /students/{slug}. */
const PROGRAMS_GRID = [
  { icon: FaRocket,     title: 'Space & Science',     desc: 'Explore the universe, study celestial bodies, and build models.',           img: 1, slug: 'space-science'        },
  { icon: FaRobot,      title: 'Space Robotics',      desc: 'Design, build, and program robots that solve real-world problems.',          img: 2, slug: 'space-robotics'       },
  { icon: FaBrain,      title: 'AI & Data Science',   desc: 'Understand AI concepts and build intelligent systems.',                       img: 3, slug: 'ai-and-data-science'  },
  { icon: FaHelicopter, title: 'Drones',              desc: 'Learn drone technology, flight systems, and applications.',                   img: 4, slug: 'drones'               },
  { icon: FaCube,       title: 'Aeromodelling',       desc: 'Design, prototype and fly your own aircraft — flight principles + builds.',  img: 5, slug: 'aeromodelling'        },
];

/* Left-panel feature pills — 3 items. */
const PROGRAMS_FEATURES = [
  { icon: FaRocket, title: 'Real-World Learning', desc: 'Work on projects inspired by real-world challenges.' },
  { icon: FaUsers,  title: 'Expert Mentorship',   desc: 'Learn and grow with guidance from industry professionals.' },
];
...
const LOREM = 'Participating in Lab of Future transformed the way our students approach science and technology. The hands-on projects are inspiring and truly future-ready.';
...
const StudentPartnership = () => (
  <section className="student-partnership-section">
    ...
    <h2 className="student-partnership-title">Partnership</h2>
    ...
    >
      ...
      <div className="student-wwd-inner container">
        ...
        >
          ...
          <span className="student-wwd-corner student-wwd-corner--tr" aria-hidden="true" />
          <span className="student-wwd-corner student-wwd-corner--bl" aria-hidden="true" />

          <span className="student-wwd-icon" aria-hidden="true">
            <FaBullseye />
          </span>

          <span className="student-wwd-eyebrow">Reimagining Education Through Experience</span>

          <h2 className="student-wwd-title">What <span className="student-wwd-title-accent">We Do?</span>
          </h2>
          ...
          <p className="student-wwd-desc">Lab of Future partners with schools to deliver immersive, hands-on STEM education through cutting-edge programs in Space Science, Robotics, Artificial Intelligence, Aerospace, IoT, and Future Technologies.</p>
      ...
      <div className="student-programs-inner container">
        ...
        >
          <span className="student-programs-eyebrow">
            Programs
            <span className="student-programs-eyebrow-line" aria-hidden="true" />
          </span>
          ...
          <p className="student-programs-desc">
            Hands-on learning experiences designed to inspire curiosity,
            build skills, and empower students to solve real-world
            challenges.
          </p>
          ...
          <ul className="student-programs-features">
            {PROGRAMS_FEATURES.map(({ icon: Icon, title, desc }) => (
              <li className="student-programs-feature" key={title}>
                <span className="student-programs-feature-icon" aria-hidden="true">
                  <Icon />
                </span>
                <span className="student-programs-feature-body">
                  <span className="student-programs-feature-title">{title}</span>
                  <span className="student-programs-feature-desc">{desc}</span>
                </span>
              </li>
            ))}
          </ul>
    ...
    >
      <div className="student-cta-inner container">
        <div className="student-cta-text">
          <h2 className="student-cta-title">
            THE FUTURE WON&apos;T BE TAUGHT
            <br />
            IT WILL BE BUILT
          </h2>
          <p className="student-cta-desc">
...
<button type="button" onClick={openEnquiry} className="student-btn student-btn--primary">
    ...
    >
      ...
      <div className="container">
        <h2 className="student-missions-title">
          STUDENT MISSIONS &amp; <span className="student-missions-badge">CHALLENGES</span>
        </h2>
        <p className="student-missions-sub">Build. Experiment. Achieve.</p>
        <p className="student-missions-desc">
          Participate in exciting missions inspired by real-world scientific and
      ...
      <div className="student-cert-inner container">
        ...
        <div className="student-cert-text">
          ...
          <ul className="student-cert-list">
            ...
            <li>
              Recognised credentials that showcase skills to schools,
        ...
        <div className="student-cert-stage">
          <div className="student-cert-stack">
            <img className="student-cert-card student-cert-card--1" src={studentCertImg} alt="" aria-hidden="true" loading="lazy" />
            <img className="student-cert-card student-cert-card--2" src={studentCertImg} alt="" aria-hidden="true" loading="lazy" />
            <img className="student-cert-card student-cert-card--3" src={studentCertImg} alt="LOF certificate" loading="lazy" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="student-modes-section">
      <div className="container">
        <h2 className="modes-title">BEYOND LEARNING</h2>
        <p className="modes-subtitle">JOIN A COMMUNITY OF INNOVATORS</p>
          ...
          {STUDENT_MODE_CARDS.map((c) => (
            <article className="modes-card" key={c.label}>
              <div className="modes-card-imgwrap">
                <img className="modes-card-img" src={c.img} alt={c.label} loading="lazy" />
              </div>
...
/* ─────────────────────── SITE FOOTER ───────────────────────
   ...
   Uses the global .site-footer-* styles from home.css. */
const SiteFooter = () => (
